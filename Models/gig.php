...
class Gig extends Model
{
    ...
    {
        try {
            $sql = "SELECT gig.gigId, gig.title, gig.image, gig.capital, gig.location, gig.category, gig.timePeriod, user.firstName, user.lastName FROM gig INNER JOIN user ON gig.farmerId = user.uid";
            if ($order == "ASC") {
