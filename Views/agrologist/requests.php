                    ...
                    ?>
                        ...
                        <div class="[ request__card bg-light ]">
                            <div class="[ request__img ]">
                                <img src="<?php echo UPLOADS . '/profilePictures/' . $request['image'] ?>" alt="" <?php echo DEFAULT_PROFILE_PICTURE ?>>
                            </div>
                            <form action="<?php echo URLROOT . '/agrologist/requests' ?>" method="POST">
                                <div class="flex flex-row " style="width: 600px">
                                    <div class="[ request__content ]">
                                        ...
                                        <meter class="average-rating" min="0" max="5" value="5" title="4.3 out of 5 stars" style="--percent: calc(<?php echo $request['total'] / ($request['num'] * 3) ?>/5*100%)">4.3
                                            out of 5</meter>

                                    </div>
                                    <div class="flex flex-row flex-c-c">
                                        <a class="btn btn-primary mr-2 mt-2 accept_button" onclick="accept_model_open('<?php echo $request['requestId'] ?>')" name="accept_btn">Accept</a>
                                        <a href="#" class="btn btn-danger mt-2" onclick="decline_model_open('<?php echo $request['requestId'] ?>')" name="edit_details">Decline</a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div id="decline_modal" class="modal">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form class="form pt-1" action="<?php echo URLROOT . '/agrologist/requests' ?>" method="post" enctype="multipart/form-data">
