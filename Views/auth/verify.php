        ...
        <div class="[ content ]">
            ...
            <div class="[ card ]">
                ...
                <form class="form" action="<?php echo URLROOT ?>/auth/verify" method="post">
                    ...
                    <p>This is a one-time code and it will expire after a 5 minites.</p>
                    <button type="submit" name="verify" class="button__primary nextBtn">Next</button>
                    <p>Didn't receive any email? <a class="register" href="<?php echo URLROOT ?>/auth/resend">Resend</a></p>
                </form>
            </div>
