    ...
    <div class="container" container-type="dashboard-section">
        ...
        <div class="cardpad">
         ...
         <div class="cardtechfst">
            <div class="cardimg">
                <img class="techimg" src="<?php echo IMAGES ?>/agrologist/agrologist8.jpg" alt="profile">
                <div class="cardbox">
                    <div class="techflex">
        ...
        <div class="cardtechfst">
          <div class="cardimg">
             <img class="techimg" src="<?php echo IMAGES ?>/agrologist/agrologist5.jpg" alt="profile">
                 <div class="cardbox">
                    <div class="techflex">
        ...
        <a class="[ text-dec-none  text-dark  ]" href="<?php echo URLROOT . "/farmer/agrologistprofile/" ?>">
            ...
            <div class="cardtechfst">
            <div class="cardimg">
                <img class="techimg" src="<?php echo IMAGES ?>/agrologist/agrologist3.jpg" alt="profile">
                    <div class="cardbox">
                        <div class="techflex">
        ...
        <a class="[ text-dec-none  text-dark  ]" href="<?php echo URLROOT . "/farmer/agrologistprofile/" ?>">
            ...
            <div class="cardtechfst">
                <div class="cardimg">
                    <img class="techimg" src="<?php echo IMAGES ?>/agrologist/agrologist4.jpg" alt="profile">
                    <div class="cardbox">
                        <div class="techflex">
            ...
            <div class="cardtechfst">
            <div class="cardimg">
                <img class="techimg" src="<?php echo IMAGES ?>/agrologist/agrologist7.jpg" alt="profile">
                    <div class="cardbox">
                        <div class="techflex">
             ...
             <a class="[ text-dec-none  text-dark  ]" href="<?php echo URLROOT . "/farmer/agrologistprofile/" ?>">
                ...
                <div class="cardtechfst">
                <div class="cardimg">
                    <img class="techimg" src="<?php echo IMAGES ?>/agrologist/agrologist6.jpg" alt="profile">
                        <div class="cardbox">
                            <div class="techflex">
